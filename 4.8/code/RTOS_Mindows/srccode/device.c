...
void DEV_SoftwareInit(void)
{
    ...
    /* 创建打印队列和信号量 */
    gpstrSerialMsgQue = MDS_QueCreate((M_QUE*)NULL);
    gpstrLcdMsgSem = MDS_SemCreate((M_SEM*)NULL, SEMPRIO, SEMEMPTY);

    /* 创建信号量 */
    gpstrSemSync = MDS_SemCreate((M_SEM*)NULL, SEMPRIO, SEMEMPTY);
    gpstrSemMute = MDS_SemCreate((M_SEM*)NULL, SEMPRIO, SEMFULL);
...
void DEV_BufferInit(BUFPOOL* pstrBufPool)
{
    ...
    (void)MDS_SemCreate(&pstrBufPool->strSem, SEMPRIO, SEMFULL);
