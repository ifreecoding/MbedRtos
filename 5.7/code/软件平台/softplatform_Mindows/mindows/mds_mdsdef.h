...
/* Mindows版本号 */
#define MINDOWS_VER                 "001.001.001.000"
...
/* 保存CPU占有率的结构体 */
typedef struct m_cpushare
{
    U32 uiSysTickVal;               /* 任务切换进来的时钟值 */
    U32 uiCounter;                  /* CPU占有率计数值 */
...
#ifdef MDS_CPUSHARE
    M_CPUSHARE strCpuShare;         /* CPU占有率结构 */
#endif
}M_TCB;
