...
#define CPUSHARETIME        (1000 / TICK)   /* 统计CPU占有率的周期, 单位: tick */
...
#ifdef MDS_CPUSHARE
extern void MDS_CpuShareInit(void);
extern void MDS_TaskCpuShareInit(M_TCB* pstrTcb);
extern void MDS_CpuShareStatistic(M_TCB* pstrOldTcb, M_TCB* pstrNewTcb);
#endif
