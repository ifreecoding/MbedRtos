...
U8 gaucIdleTaskStack[IDLETASKSTACK];    /* 空闲任务的栈 */
...
void MDS_SystemVarInit(void)
{
    ...
    /* 创建前根任务 */
    gpstrRootTaskTcb = MDS_TaskCreate(ROOTTASKNAME, MDS_BeforeRootTask, NULL,
                           gaucRootTaskStack, ROOTTASKSTACK, USERHIGHESTPRIO, NULL);

    /* 创建空闲任务 */
    gpstrIdleTaskTcb = MDS_TaskCreate(IDLETASKNAME, MDS_IdleTask, NULL,
                                gaucIdleTaskStack, IDLETASKSTACK, LOWESTPRIO, NULL);
}
